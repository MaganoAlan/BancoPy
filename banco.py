...
def criar_conta() -> None:
    print('nforme os dados do cliente: ')
...
def efetuar_depoisito() -> None:
    if len(contas) > 0:
        ...
        if conta:
            ...
            print(f'Não foi encontrada uma conta de número {numero}')
    else:
        print('Ainda não existem contas cadastradas.')
    sleep(2)
    menu()
...
def efetuar_transferencia() -> None:
    if len(contas) > 0:
        ...
        if conta_origem:
            ...
            print(f'A sua conta com numero: {numero_origem} não foi rncontrada.')
    else:
        print('Ainda não existem contas cadastradas.')
    sleep(2)
    menu()
